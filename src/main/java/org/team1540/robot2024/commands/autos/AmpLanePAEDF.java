...
public class AmpLanePAEDF extends AutoCommand {

    public AmpLanePAEDF(Drivetrain drivetrain, Shooter shooter, Indexer indexer) {
        super("AmpLanePAEDF");

        addPath(
                PathHelper.fromChoreoPath("AmpLanePAEDF.1", true, true),
                PathHelper.fromChoreoPath("AmpLanePAEDF.2"),
                PathHelper.fromChoreoPath("AmpLanePAEDF.3"),
                PathHelper.fromChoreoPath("AmpLanePAEDF.4"),
                PathHelper.fromChoreoPath("AmpLanePAEDF.5")
        );
