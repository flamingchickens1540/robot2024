...
public class SoureLanephChaos extends AutoCommand {

    public SoureLanephChaos(Drivetrain drivetrain, Shooter shooter, Indexer indexer) {
        super("!SourceLanephChaos");

        addPath(
                PathHelper.fromChoreoPath("SourceLanephChaos.1", true, true)
        );
