...
public class CenterLanePSubCSubBSubASub extends AutoCommand {

    public CenterLanePSubCSubBSubASub(Drivetrain drivetrain, Shooter shooter, Indexer indexer ) {
        super("CenterLanePsCsBsAsBearMetal");
        addPath(
