...
public class CenterLanePCBADE extends AutoCommand {

    public CenterLanePCBADE(Drivetrain drivetrain, Shooter shooter, Indexer indexer) {
        super("CenterLanePCBADE");
        addPath(
                PathHelper.fromChoreoPath("CenterLanePCBADE.1", false, true),
                PathHelper.fromChoreoPath("CenterLanePCBADE.2"),
                PathHelper.fromChoreoPath("CenterLanePCBADE.3"),
                PathHelper.fromChoreoPath("CenterLanePCBADE.4"),
                PathHelper.fromChoreoPath("CenterLanePCBADE.5")
